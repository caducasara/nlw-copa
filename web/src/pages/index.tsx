...
import AppPreviewImg from '../assets/nwlCopaPreview.png';
import Logo from '../assets/logo.svg';
import usersAvatares from '../assets/avatares.png';
...
export default function Home(props: HomeProps) {
  ...
  return (
   <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      ...
      <Image 
        src={AppPreviewImg} 
        alt="Dois celulares exibiindo uma prévia da aplicação mobile da NLW Copa"
        quality={100}
      />
   </div>
  )
